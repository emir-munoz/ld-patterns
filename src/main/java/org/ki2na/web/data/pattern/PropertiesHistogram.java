...
public class PropertiesHistogram
{

	private final static transient Logger _log = LoggerFactory.getLogger(PropertiesHistogram.class.getName());
	...
	public static void main(String[] args)
	{
		...
		try
		{
			out = new PrintWriter("./dtHistogram/propertySize.txt");
			...
			for (String file : fileNames)
			{
				...
				propSize = pp.getSize(file);

				out.println(propSize + "\t" + file);
				out.flush();
			}
			// close file
			out.close();
